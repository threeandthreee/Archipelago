...
class TestDeprecations(TestCase):
    ...
    def test_validators_ErrorTree(self):
        """
        As of v4.0.0, importing ErrorTree from .validators is
        deprecated in favor of doing so from .exceptions.
        """

        message = "Importing ErrorTree from .validators is "
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from .validators import ErrorTree
    ...
    def test_import_Validator(self):
        ...
        deprecated in favor of doing so from .protocols.
        """
    ...
    def test_RefResolver(self):
        ...
        with self.assertWarnsRegex(DeprecationWarning, message) as w:
            from .validators import RefResolver  # noqa: F401
        self.assertEqual(w.filename, __file__)
