...
connections: dict[str, RegionConnectionData] = {
    ...
    "Route 6 north east cave entrance": RegionConnectionData("Route 6", "Mistralton Cave Entrance", can_use_surf),
    ...
    "Route 9 cave entrance": RegionConnectionData("Route 9", "Challenger's Cave", has_red_chain),
