...
all_locations: List[LocationData] = [
    ...
    LocationData("Temple of the Seeing One - Shieldy Room Chest", "Bedroom",
                 ["Combat", "Small Key (Temple of the Seeing One):3"]),
    ...
    LocationData("Circus - Double Clowns Chest", "Circus 4", ["Combat", "Jump Shoes", "Small Key (Circus):4"]),
    ...
    LocationData("Mountain Cavern - 2F Crowded Ledge Chest", "Crowd floor 2",
                 ["Combat", "Jump Shoes", "Small Key (Mountain Cavern):4"]),
    ...
    LocationData("Space - Challenge Area Chest", "Space Gauntlet", ["Combat", "Jump Shoes", "Progressive Swap:2"]),
    ...
    LocationData("Apartment - 2F Switch Pillar Rat Maze Dust", "Apartment floor 2", ["Jump Shoes"], dust=True),
    LocationData("Apartment - 2F Dash Trap Rat Maze Dust", "Apartment floor 2", ["Jump Shoes"], dust=True),
    ...
    LocationData("Temple of the Seeing One - Laser Room Dust 1", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Laser Room Dust 2", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Room With Holes Dust 1", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Room With Holes Dust 2", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Past Shieldy Puzzle Dust 1", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Before Boss Dust 1", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Past Shieldy Puzzle Dust 2", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Shieldy Room Dust 1", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Shieldy Room Dust 2", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Laser Room Dust 3", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Entrance Dust 1", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Entrance Dust 2", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Before Boss Dust 2", "Bedroom", dust=True),
    LocationData("Temple of the Seeing One - Laser Room Dust 4", "Bedroom", dust=True),
    LocationData("Blue - Laser Room Dust", "Blue", ["Jump Shoes"], dust=True),
    LocationData("Circus - Dash Trap Dust", "Circus", dust=True),
    LocationData("Circus - Fire Pillars in Water Dust 3", "Circus 3", dust=True),
    LocationData("Circus - Lion Dust 1", "Circus 3", dust=True),
    LocationData("Circus - Lion Dust 2", "Circus 3", dust=True),
    LocationData("Circus - Fire Pillars in Water Dust 2", "Circus 3", dust=True),
    LocationData("Circus - Fire Pillars in Water Dust 1", "Circus 3", dust=True),
    # Overlaps with Fire Pillars in Water Dust 3
    LocationData("Circus - Fire Pillars in Water Dust 4", "Circus 3", dust=True),
    LocationData("Circus - Dog Room Dust", "Circus", dust=True),
    LocationData("Circus - Javiera Dust 2", "Circus 2", dust=True),
    LocationData("Circus - Javiera Dust 1", "Circus 2", dust=True),
    LocationData("Circus - Slime and Fire Pillar Dust", "Circus 2", dust=True),
    LocationData("Circus - Small Contort Room Dust", "Circus 3", dust=True),
    LocationData("Circus - Save Point Dust", "Circus 3", dust=True),
    LocationData("Circus - Clown Dust 1", "Circus", dust=True),
    LocationData("Circus - Clown Dust 2", "Circus", dust=True),
    LocationData("Circus - Spike Dust", "Circus", dust=True),
    LocationData("Circus - Dash Pad over Hole Dust", "Circus", dust=True),
    LocationData("Circus - Lion and Dash Pad Dust", "Circus", dust=True),
    LocationData("Circus - Spike Roller in Water Dust", "Circus", dust=True),
    ...
    LocationData("Mountain Cavern - 3F Roller Dust", "Crowd floor 3", dust=True),
    LocationData("Mountain Cavern - 2F Frogs and Annoyers Dust", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Rotators and Annoyers Dust 1", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Rotators and Annoyers Dust 2", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Circular Hole Dust 1", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Circular Hole Dust 2", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Crossing Moving Platforms Dust 1", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Crossing Moving Platforms Dust 2", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Moving Platform Crossroad Dust 1", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Moving Platform Crossroad Dust 2", "Crowd floor 2", ["Jump Shoes"], dust=True),
    LocationData("Mountain Cavern - 2F Moving Platform Crossroad Dust 3", "Crowd floor 2", ["Jump Shoes"], dust=True),
    ...
    LocationData("Fields - Lake After Spikes Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - North River Dust", "Fields", dust=True),
    LocationData("Fields - Lake After Holes Floating Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - South East of Lake Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - Lake Near Windmill Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - North of Lake Rapids Dust", "Fields", dust=True),
    LocationData("Fields - North East of Lake Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    ...
    LocationData("Fields - South West Corner Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - South East of Gauntlet Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - Before Gauntlet Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - Island Chest Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - Island Start Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - Post Whirlpool Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    LocationData("Fields - Olive Dust", "Fields Lake", ["Jump Shoes"], dust=True),
    ...
    LocationData("Happy - Final Room Dust", "Happy", dust=True),
    LocationData("Happy - Dustmaid Dust", "Happy", dust=True),
    ...
    LocationData("Red Cave - Middle Cave Left Dust 1", "Red Cave center", dust=True),
    LocationData("Red Cave - Middle Cave Left Dust 2", "Red Cave center", dust=True),
    ...
    LocationData("Space - Challenge Area Dustmaid Dust 1", "Space Gauntlet", ["Progressive Swap:2", "Jump Shoes"], dust=True),
    LocationData("Space - Challenge Area Dustmaid Dust 2", "Space Gauntlet", ["Progressive Swap:2", "Jump Shoes"], dust=True),
    ...
    LocationData("Boss Rush - Before Red Boss Dust", "Boss Rush", ["Progressive Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Red Boss Dust 1", "Boss Rush", ["Progressive Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Red Boss Dust 2", "Boss Rush", ["Progressive Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Red Boss Dust 3", "Boss Rush", ["Progressive Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Red Boss Dust 4", "Boss Rush", ["Progressive Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Manager Phase 1 Dust", "Boss Rush", ["Progressive Swap:2", "Jump Shoes"], dust=True),
    LocationData("Boss Rush - Manager Phase 2 Dust", "Boss Rush", ["Progressive Swap:2", "Jump Shoes"], dust=True)
]
