...
all_locations: List[LocationData] = [
    ...
    LocationData("Fields - Goldman's Cave Dust 1", "Fields Goldman's Cave", dust=True),
    LocationData("Fields - Goldman's Cave Dust 2", "Fields Goldman's Cave", dust=True),
    LocationData("Fields - Goldman's Cave Dust 3", "Fields Goldman's Cave", dust=True),
    LocationData("Fields - Goldman's Cave Dust 4", "Fields Goldman's Cave", dust=True),
    LocationData("Fields - Goldman's Cave Dust 5", "Fields Goldman's Cave", dust=True),
    LocationData("Fields - Goldman's Cave Dust 6", "Fields Goldman's Cave", dust=True),
    LocationData("Fields - Goldman's Cave Dust 7", "Fields Goldman's Cave", dust=True),
    LocationData("Fields - Goldman's Cave Dust 8", "Fields Goldman's Cave", dust=True),
    LocationData("Fields - Goldman's Cave Dust 9", "Fields Goldman's Cave", dust=True),
    ...
    LocationData("Fields - Near Terminal Dust", "Terminal", dust=True),
