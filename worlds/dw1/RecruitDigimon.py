...
[
    ...
    ("Greymon",            2, ["Agumon"], 15, True),
    ("Monochromon",        2, ["Agumon"], 1, True),
    ...
    ("Birdramon",          2, ["Agumon"], 1, True),
    ("Unimon",             2, ["Agumon","Centarumon", "Meramon"], 1, True),
    ("Penguinmon",         1, ["Agumon"], 1, True),
    ("Mojyamon",           2, ["Agumon"], 1, True),
    ("Angemon",            2, ["Agumon"], 1, True),
    ("Vegiemon",           2, ["Agumon", "Palmon"], 1, True),
    ("Shellmon",           2, ["Agumon"], 6, True),
    ("Piximon",            3, ["Agumon"], 1, True),
    ("Whamon",             2, ["Agumon"], 1, True),
    ("Numemon",            1, ["Agumon","Whamon"], 1, True),
    ("Giromon",            3, ["Agumon","Numemon"], 1, True),
    ("Andromon",           3, ["Agumon", "Numemon"], 1, True),
    ("Frigimon",           2, ["Agumon"], 1, True),
    ("Seadramon",          2, ["Agumon"], 1, True),
    ("Garurumon",          2, ["Agumon"], 1, True),
    ("Monzaemon",          3, ["Agumon"], 1, True),
    ("Kokatorimon",        2, ["Agumon"], 1, True),
    ...
    ("MetalGreymon",       3, ["Agumon","Greymon"], 50, True),
