...
item_pools_template: dict[str, list[ItemPoolEntry]] = {
    ...
    "equipChests": [
        ...
        ItemPoolEntry(item=items_dict['Rough Branch', 2], quantity=1),
        ...
        ItemPoolEntry(item=items_dict["Thief's Band", 1], quantity=1),
        ItemPoolEntry(item=items_dict['Dented Crown', 1], quantity=1),
        ItemPoolEntry(item=items_dict['Tengu Mask', 1], quantity=1),
        ItemPoolEntry(item=items_dict["Burglar's Rope", 1], quantity=1),
    ...
    "equipQuests": [
        ItemPoolEntry(item=items_dict["Edge o' All", 2], quantity=1),
        ItemPoolEntry(item=items_dict['Swiftspike', 1], quantity=1),
