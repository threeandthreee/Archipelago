...
class REGION_INDICIES:
    ...
    CRYPTIC_CASTLE_ENEMY_HAWKS = 5
    CRYPTIC_CASTLE_KEY_DOOR = 6
    CRYPTIC_CASTLE_BOMB_EASY_2 = 7
    CRYPTIC_CASTLE_ENEMY_HAWKS_2 = 8
    ...
    CIRCUS_PARK_SECOND_CHECKPOINT_HERO_GOAL = 3
    CIRCUS_PARK_GUN_TURRET = 4
    CIRCUS_PARK_KEY_DOOR = 5
    CIRCUS_PARK_ROCKET = 6
    CIRCUS_PARK_PULLEY = 7
    CIRCUS_PARK_HERO_GOAL_STANDARD = 8
    CIRCUS_PARK_HERO_GOAL = 9
    ...
    BLACK_COMET_BLACK_TURRET = 4
    BLACK_COMET_WARP_HOLE = 5
