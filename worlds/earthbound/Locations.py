...
def get_locations(world: "EarthBoundWorld") -> List[LocationData]:
    ...
    if world.options.shop_randomizer == 2:
        location_table += [
            ...
            LocationData("Twoson", "Twoson Department Store Top Floor - Right Counter Slot 2", 0xeb1039),
            ...
            LocationData("Fourside", "Moonside Hotel - Shop Slot 1", 0xeb119d),
            LocationData("Fourside", "Moonside Hotel - Shop Slot 2", 0xeb119e),
            LocationData("Fourside", "Moonside Hotel - Shop Slot 3", 0xeb119f),
            LocationData("Fourside", "Moonside Hotel - Shop Slot 4", 0xeb11a0),
            LocationData("Fourside", "Moonside Hotel - Shop Slot 5", 0xeb11a1),
