...
def create_scaling_data(world: "PokemonFRLGWorld"):
    ...
    kanto_trainer_data = {
        ...
        "Route 22": [{"name": "Route 22 Early Rival",
                     ...
                     {"name": "Route 22 Late Rival",
                      "rule": lambda state: state.has("Defeat Route 22 Rival", world.player) and
                                            state.has("Defeat Giovanni", world.player),
        ...
        "S.S. Anne 2F Corridor": [{"name": "S.S. Anne Rival", "data_ids": ["TRAINER_RIVAL_SS_ANNE_BULBASAUR",
        ...
        "Silph Co. 7F Northwest Room": [{"name": "Silph Co. Rival", "data_ids": ["TRAINER_RIVAL_SILPH_BULBASAUR",
    ...
    sevii_trainer_data = {
        ...
        "Mt. Ember Exterior South": [{"name": "Team Rocket Grunt 43",
                                      "rule": lambda state: state.has("Deliver Meteorite", world.player),
                                      "data_ids": ["TRAINER_TEAM_ROCKET_GRUNT_43"]},
                                     {"name": "Team Rocket Grunt 44",
                                      "rule": lambda state: state.has("Deliver Meteorite", world.player),
                                      "data_ids": ["TRAINER_TEAM_ROCKET_GRUNT_44"]}],
    ...
    kanto_static_encounter_data = {
        ...
        "Celadon Game Corner Prize Room": [{"name": "Prize Pokemon 1",
                                           ...
                                           {"name": "Prize Pokemon 2",
                                            "rule": lambda state: state.has("Coin Case", world.player),
                                            "data_ids": ["CELADON_PRIZE_POKEMON_2"]},
                                           {"name": "Prize Pokemon 3",
                                            "rule": lambda state: state.has("Coin Case", world.player),
                                            "data_ids": ["CELADON_PRIZE_POKEMON_3"]},
                                           {"name": "Prize Pokemon 4",
                                            "rule": lambda state: state.has("Coin Case", world.player),
                                            "data_ids": ["CELADON_PRIZE_POKEMON_4"]},
                                           {"name": "Prize Pokemon 5",
                                            "rule": lambda state: state.has("Coin Case", world.player),
        ...
        "Pokemon Lab Experiment Room": [{"name": "Gift Omanyte",
                                        ...
                                        {"name": "Gift Kabuto",
                                         "rule": lambda state: state.has("Dome Fossil", world.player),
                                         "data_ids": ["GIFT_POKEMON_KABUTO"]},
