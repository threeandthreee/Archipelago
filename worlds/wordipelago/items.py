...
item_data_table: Dict[str, WordipelagoItemData] = {
    ...
    "Letter J": WordipelagoItemData(code=10,type=ItemClassification.useful),
    "Letter K": WordipelagoItemData(code=11,type=ItemClassification.useful),
    ...
    "Letter Q": WordipelagoItemData(code=17,type=ItemClassification.useful),
    ...
    "Letter V": WordipelagoItemData(code=22,type=ItemClassification.useful),
    "Letter W": WordipelagoItemData(code=23,type=ItemClassification.progression),
    "Letter X": WordipelagoItemData(code=24,type=ItemClassification.useful),
    "Letter Y": WordipelagoItemData(code=25,type=ItemClassification.progression),
    "Letter Z": WordipelagoItemData(code=26,type=ItemClassification.useful),
