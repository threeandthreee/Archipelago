...
trade_item_prog = ItemClassification.progression_deprioritized
progression_useful = ItemClassification.progression | ItemClassification.useful

links_awakening_items = [
    ItemData(ItemName.POWER_BRACELET, "POWER_BRACELET", progression_useful),
    ItemData(ItemName.SHIELD, "SHIELD", progression_useful),
    ItemData(ItemName.BOW, "BOW", progression_useful),
    ItemData(ItemName.HOOKSHOT, "HOOKSHOT", progression_useful),
    ItemData(ItemName.MAGIC_ROD, "MAGIC_ROD", progression_useful),
    ItemData(ItemName.PEGASUS_BOOTS, "PEGASUS_BOOTS", progression_useful),
    ItemData(ItemName.OCARINA, "OCARINA", progression_useful),
    ItemData(ItemName.FEATHER, "FEATHER", progression_useful),
    ItemData(ItemName.SHOVEL, "SHOVEL", progression_useful),
    ItemData(ItemName.MAGIC_POWDER, "MAGIC_POWDER", progression_useful),
    ItemData(ItemName.BOMB, "BOMB", progression_useful),
    ItemData(ItemName.SWORD, "SWORD", progression_useful),
    ItemData(ItemName.FLIPPERS, "FLIPPERS", progression_useful),
    ...
    ItemData(ItemName.GOLD_LEAF, "GOLD_LEAF", ItemClassification.progression_deprioritized),
    ItemData(ItemName.RUPEES_20, "RUPEES_20", ItemClassification.progression_deprioritized_skip_balancing),
    ItemData(ItemName.RUPEES_50, "RUPEES_50", ItemClassification.progression_deprioritized_skip_balancing),
    ItemData(ItemName.RUPEES_100, "RUPEES_100", ItemClassification.progression_deprioritized_skip_balancing),
    ...
    ItemData(ItemName.BOOMERANG, "BOOMERANG", progression_useful),
    ...
    ItemData(ItemName.ROOSTER, "ROOSTER", progression_useful),
    ...
    ItemData(ItemName.TOADSTOOL, "TOADSTOOL", progression_useful),
    ...
    DungeonItemData(ItemName.STONE_BEAK, "STONE_BEAK", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK1, "STONE_BEAK1", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK2, "STONE_BEAK2", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK3, "STONE_BEAK3", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK4, "STONE_BEAK4", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK5, "STONE_BEAK5", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK6, "STONE_BEAK6", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK7, "STONE_BEAK7", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK8, "STONE_BEAK8", ItemClassification.useful),
    DungeonItemData(ItemName.STONE_BEAK9, "STONE_BEAK9", ItemClassification.useful),
